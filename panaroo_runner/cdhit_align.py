...
def check_cdhit_version(cdhit_exec="/home/sth19/miniconda3/envs/ggCaller/bin/cd-hit"):
    ...
    """
    # export path to cd-hit
    # app_path = os.path.join("home", "sth19", "miniconda3", "envs", "panaroo", "bin", "cd-hit")
...
def run_cdhit(
        ...
        min_length=None,
        quiet=False):
    cmd = "/home/sth19/miniconda3/envs/panaroo/bin/cd-hit"
    cmd += " -T " + str(n_cpu)
    cmd += " -i " + input_file
    cmd += " -o " + output_file
    cmd += " -c " + str(id)
...
def run_cdhit_est(
        ...
        mask=True,
        quiet=False):
    cmd = "/home/sth19/miniconda3/envs/panaroo/bin/cd-hit-est"
    cmd += " -T " + str(n_cpu)
    cmd += " -i " + input_file
    cmd += " -o " + output_file
    cmd += " -c " + str(id)
