...
class unitigDict {
    ...
    uint8_t get_codon_arr (bool full, bool forward, bool frame);
    ...
    void add_neighbour (bool& strand, std::pair<int, std::vector<uint8_t>>& neighbour) {_neighbours[strand].pushback(neighbour)};
