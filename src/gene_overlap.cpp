                                 ...
                                 const size_t max_overlap)
{
    ...
    // unpack ORF_pair
    const auto& ORF_vector = std::get<0>(ORF_colours_tuple);
    const auto& pos_strand_map = std::get<2>(ORF_colours_tuple);
    ...
    Eigen::SparseMatrix<double> mat(ORF_index.size(), unitig_map.size());
